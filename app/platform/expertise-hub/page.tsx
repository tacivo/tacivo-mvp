  ...
  const items = [
    {
      icon: User,
      title: 'My Expertise',
      description: 'Your personal expertise areas and processes',
      href: '/platform/my-expertise',
    },
    {
      icon: Users,
      title: 'Shared Expertise',
      description: 'Expertise shared across your organization',
      href: '/platform/shared-expertise',
    },
    {
      icon: Plus,
      title: 'Add New Expertise',
      description: 'Start a new AI-powered interview to capture your expertise',
      href: '/interview',
      accent: true,
    },
  ]
    ...
    <div className="max-w-4xl mx-auto px-8 py-12">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-4xl font-semibold text-foreground">Expertise</h1>
        </div>
        <p className="text-muted-foreground">
          Manage and explore expertise within your organization
        </p>
      </div>
